        ...
        <div className={styles.container}>
            ...
            <section className={styles.section}>
                ...
                <p>
                    ...
                    Las recomendaciones se basan en cuántas materias desbloquea cada una, y las siguiente correlativas de esas, y así sucesivamente.
                    Recién al completar todas las notas(aprobados y desaprobados), se va a ver el promedio y ranking real.
                </p>
            </section>
            ...
            <section className={styles.section}>
                ...
                <p>
                    Creo que al principio a la gente le cuesta ver qué materias puede hacer y cuáles no, asique fue un poco para ayudar a esa gente.
